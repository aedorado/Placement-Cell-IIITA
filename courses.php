<!DOCTYPE html>
	...
	<body>
		...
		<div class="row page-title">
		 	<h2 class="white-text center-align">Courses</h2> 
		</div>
		...
		<div class="row block" id="courses">
			...
			<div class="col s10 offset-s1 body">
				...
				<p>
					...
					<ul>
						<li>Wireless Communication Engineering (WCE)</li>
						<li>Software Engineering (SE)</li>
						<li>Cyber Law and Information Security (CLIS)</li>
						<li>Intelligent Systems (IS)</li>
						<li>Robotics (RO)</li>
						<li>Human Computer Interaction (HC)</li>
						<li>Microelectronics(ME)</li>
						<li>Bioinformatics (BI) </li>
						<li>Integrated M. Tech in Biomedical Engineering. (BME)</li>
					</ul>
					IIIT Allahabad provides excellence of specialization in the field of information technology in India. The objective of M.Tech is to prepare quality professionals to work at high-end technologies in IT and to deliver future project leaders and architects, who can meet the challenges, make better use of technologies and understand the need of modern IT services. Here students are trained to work in a team, lead it, allowing exposure to the practicability and difficulties involved in the projects of varying complexities to make sure that the students have the capability to turn the dreams of business leaders and visionaries into realities.The curriculum is designed in such a manner that student get the excellent knowledge of the specialized field. 'Thesis work' which provides an opportunity to students to create and develop new concept, techniques, methods and applications in the real world.
				</p>
			</div>
		</div>
		...
		<div class="row block" id="course_overview">
			<div class="block-title col s12 valign-wrapper">
				<span class="valign leftline"></span>
				<p class="valign title">Course Overview</p>
				<span class="valign rightline"></span>
			</div>
			<div class="col s10 offset-s1 body">
					...
					<div class="course-body">
						<div class="courses col l4 m6 s12">
							...
							<ul>
								<li>Algorithms</li>
								<li>Networking</li>
								<li>Graphic and Visual Computing</li>
						...
						<div class="courses col l4 m6 s12">
							<p>Modelling and Optimization</p>
							<ul>
								<li>Operation Research and Optimization</li>
							...
							<ul>
								...
								<li>Computer Controlled Systems</li>
							</ul>
							<p>Data Storage &amp; Mining</p>
							<ul>
						...
						<div class="courses col l4 m6 s12">
							<p>Advance Networks,<br>Security &amp; Applications</p>
							<ul>
								<li>Data and Network Security</li>
								<li>Cryptography and information Security</li>
								<li>Mobile Intelligent Networks</li>
								<li>Storage and Network Devices</li>
								<li>Wireless Sensor Networks</li>
								<li>Distributed Systems</li>
								<li>Storage Area Networks</li>
							</ul>
							<p>Managerial Skills &amp; Personality</p>
							<ul>
								<li>Communication Skills</li>
								<li>Principles of Management &amp; Economics</li>
							...
							<ul>
								...
								<li>7th Semester Mini Project - III</li>
								<li>8th Semester Major Project</li>
							</ul>
						</div>	
					</div>
				</div>
				...
				<div class="col s12 course-container course-body-closed">
					...
					<div class="course-body">
						<div class="courses col l4 m6 s12">
							...
							<ul>
								<li>Discrete Mathematics</li>
								<li>Mathematics - I &amp; II<br>(Calculus, Numerical Met., Differential Eq.) </li>
								<li>Probability and Statistics</li>
								<li>Mathematics - III (Transformation)</li>
								<li>Physics - I &amp; II<br>(Thermodynamics, Electrostatics, Optics, Quantum Physics)</li>
							...
							<ul>
								...
								<li>Antenna &amp; Wave Propagation</li>
								<li>Wireless Sensor Networks</li>
								<li>Radar &amp; Satellite Comm.</li>
							...
							<ul>
								...
								<li>Pattern Recognition &amp; Machine Intelligence</li>
							</ul>
						</div>
						...
						<div class="courses col l4 m6 s12">
							...
							<ul>
								...
								<li>Analog Devices and Circuits</li>
								<li>Electronics Instrumentation</li>
								<li>Electronics Workshop</li>
							</ul>
							<p>VLSI</p>
							<ul>
								<li>VLSI technology (Physics &amp; Fabrication Process)</li>
								<li>VLSI - Analog Design</li>
								<li>VLSI - Digital Design</li>
								<li>Semiconductor Technology</li>
								<li>MEMS</li>
							</ul>
							<p>Communication Systems &amp; Networks</p>
							<ul>
								<li>Signals and Systems</li>
								<li>Analog Communications</li>
								<li>Digital Communications</li>
								<li>Mobile Communication</li>
								<li>Telecommunication Switching and Signalling</li>
								<li>Mobile Intelligent Networks</li>
					...
					<div class="course-body">
						<div class="courses col l4 m6 s12">
							...
							<ul>
								...
								<li>Language Algorithms &amp; Tools</li>
								<li>Data Mining in Bio Systems</li>
							...
							<ul>
								...
								<li>Advance Computer Graphics</li>
						...
						<div class="courses col l4 m6 s12">
							...
							<ul>
								...
								<li>Computer Architecture & Embedded Systems</li>
								<li>Advanced Database System & Data Mining</li>
								<li>Architecture of Intelligent Systems</li>
								<li>Intellectual Property Rights</li>
								<li>Information Retrieval</li>
							</ul>
							<p>Software Engineering</p>
							<ul>
								...
								<li>Data Ware House And Data Mining</li>
						...
						<div class="courses col l4 m6 s12">
							<p>Robotics</p>
							<ul>
								<li>Comp. Architecture &amp; Embedded Systems</li>
								<li>Mathematical formulation of robotics</li>
								<li>Control System Engineering</li>
								<li>Digital System Design</li>
								<li>Artificial Life Simulation</li>
								<li>Computational Intelligence</li>
								<li>Data Mining &amp; Warehousing</li>
								<li>Operational Research &amp; Optimization</li>
							</ul>
							<p>Wireless Comm. Engineering</p>
							<ul>
								<li>Distributed Systems</li>
								<li>Mobile Intelligent Networks</li>
								<li>Wireless Sensors Networks</li>
								<li>TCP / IP for Wireless Networks</li>
								<li>Media Access &amp; Wireless Network</li>
								<li>Cryptography &amp; Information Security</li>
								<li>Wireless Communication &amp; Computation</li>
								<li>Telecommunication &amp; Switching Networks</li>
				...
				<div class="col s12 course-container course-body-closed">
					...
					<div class="course-body">
						<div class="courses col l4 m6 s12">
							<p>Micro-Electronics</p>
							<ul>
								<li>VLSI Design</li>
								<li>VLSI Technology</li>
								<li>Modelling &amp; Analysis of VLSI Devices</li>
								<li>Hardware Design Methodologies using HDL</li>
								<li>Advanced Analog &amp; Digital VLSI Design</li>
								<li>Micro-Electromechanical Systems</li>
					...
					<div class="course-body">
						<div class="courses col l4 m6 s12">
							...
							<ul>
								...
								<li>Biological Systems - I,II </li>
								<li>Introduction to Programming</li>
								<li>Fluid Mechanics </li>
								<li>Digital Electronics </li>
								<li>Data structure andAlgorithms </li>
						...
						<div class="courses col l4 m6 s12">
							<p>Bioinformatics</p>
							<ul>
								<li>Bio signals &amp; Systems</li>
								<li>Biomedical Instrumentation</li>
								<li>Biosignal Processing </li>
								<li>Biomedical Science &amp; Engineering</li>
								<li>Biomedical Engineering Systems</li>
								<li>Biomedical System modelling &amp; Simulation</li>
						...
						<div class="courses col l4 m6 s12">
							<p>Others</p>
							<ul>
								<li>Medical Imaging - I,II</li>
								<li>Nanotechnology</li>
								<li>Communication Systems</li>
								<li>Computer Graphics and Visualization</li>
								<li>Hospital Management</li>
								<li>Principles of Management &amp; Economics</li>
								<li>Mini Projects-I,II,III,IV,V</li>
								<li>Major Project</li>
							</ul>
						</div>
					</div>
