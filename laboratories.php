	...
	<body>
		...
		<div class="row block" id="lab_gallery">
			...
			<div class="col s10 offset-s1 body">
				...
				<div class="col s6 m4 l3 image_holder">
					<img class="materialboxed" src="images/iiita/lab6.jpg">
				</div>
				<div class="col s6 m4 l3 image_holder">
					<img class="materialboxed" src="images/iiita/lab7.jpg">
				</div>
				<!-- <div class="col s6 m4 l3 image_holder">
					<img class="materialboxed" src="images/iiita/lab8.jpg">
				</div> -->
				<div class="col s6 m4 l3 image_holder">
					<img class="materialboxed" src="images/iiita/lab9.jpg">
				</div>
				<div class="col s6 m4 l3 image_holder">
					<img class="materialboxed" src="images/iiita/lab10.jpg">
				</div>
				<div class="col s6 m4 l3 image_holder">
					<img class="materialboxed" src="images/iiita/lab11.jpg">
				</div>
				<div class="col s6 m4 l3 image_holder">
					<img class="materialboxed" src="images/iiita/lab12.jpg">
				</div>
				<div class="col s6 m4 l3 image_holder">
					<img class="materialboxed" src="images/iiita/lab13.jpg">
				</div>
				<div class="col s6 m4 l3 image_holder">
					<img class="materialboxed" src="images/iiita/lab14.jpg">
				</div>
			</div>
		</div>
